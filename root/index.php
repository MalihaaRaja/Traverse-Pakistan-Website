...
{
            header('Location:http://localhost:8080/userindex.php');
}
    ?>
  ...
  <div class="navbar-inner">
    <div class="container">
      <ul class="nav" style="padding-right:0px;margin-right:0px"></ul>
                            ...
                            <li><a href="login.php">Add Event</a></li>
                           <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Login/signUp <i class="icon-angle-down"></i></a>
                                <ul class="dropdown-menu">
                                    <li id="login"><a href="login.php">Login</a></li>
                                    <li id="signUp"><a href="registration.php">signUp</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    ...
                                    <p class="animation animated-item-2">Kashmir, The Heaven on Earth</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                                    ...
                                    <p class="boxed animation animated-item-2">The Peak of Death </p>
                                    <br>
                ...
                <div class="blog_box">
                    <div class="col-sm-5 col-md-6 blog_post">
                            <ul class="list-inline">
                                ...
                                <li  class="col-md-8">
                                    <div class="pull-left">
                                        <span class="blog_header">Excuses people make not to travel in Pakistan</span><br/>
                                        <span>Posted by : <a class="link_orange" href="#"><span class="txt_orange">Tracy</span></a></span>
                                    </div>
                                    <div class="pull-right">
                                        <a href="#" role="button">11  Dec 2k14</a>
                                    </div>
                                    <div class="clearfix"> </div>
                                    <p class="blog_text">
                                        I have been traveling across Pakistan since quite a few years now. It’s easy for me to travel within the country keeping in view my low budget and nominal income. The point is, it is not at all expensive to travel within Pakistan as compared to travel abroad for vacations and it is as unsafe and safe
                                    </p>
                                </li>
                            </ul>
                        </div> <!-- /.blog_post 1 -->
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                            <ul class="list-inline">
                                ...
                                <li class="col-md-8">
                                    <div class="pull-left">
                                        <span class="blog_header">3 weird myths people have about me</span><br/>
                                        <span>Posted by : <a class="link_orange" href="#"><span class="txt_orange">Julia</span></a></span>
                                    </div>
                                    <div class="pull-right">
                                        <a href="#" role="button">23 Dec 2k14</a>
                                    </div>
                                    <div class="clearfix"> </div>
                                    <p class="blog_text">
                                       I am a storyteller, a traveler, i love tea, i work and save to travel more from time to time. I am always bombarded with questions from people having different perceptions about me. I try to clarify things via mail and now finally decided to write a blog post about it. Though the list is […]
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            ...
                            <li class="col-md-8">
                                <div class="pull-left">
                                    <span class="blog_header">Concordia: The mountaineer’s paradise</span><br/>
                                    <span>Posted by : <a class="link_orange" href="#"><span class="txt_orange">Linda</span></a></span>
                                </div>
                                <div class="pull-right">
                                    <a  href="#" role="button">8 Dec 2k14</a>
                                </div>
                                <div class="clearfix"> </div>
                                <p class="blog_text">
                                  It was a very restless night. As I lay on a glacier, in my warm sleeping bag, over a cold, hard, inhospitable and uneven surface. The silence of the wilderness was absolute and I was trying to get some sleep but the erratic and terrifying sounds of the heavy avalanches did not allow me to […]
                                </p>
                            </li>
                        </ul>
                    </div> <!-- /.blog_post 4 -->
                ...
                <div class="blog_box">
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            ...
                            <li  class="col-md-8">
                                <div class="pull-left">
                                    <span class="blog_header">A starry night & the second highest mountain</span><br/>
                                    <span>Location : <a class="link_orange" href="#"><span class="txt_orange">Islamabad</span></a></span>
                                </div>
                                <div class="pull-right">
                                    <a href="#" role="button">18 Dec 2k14</a>
                                </div>
                                <div class="clearfix"> </div>
                                <p class="blog_text">
                                  As i have always mentioned in my articles, K2 is a shy mountain. It’s always hidden behind clouds and if you are lucky it might sneak out for a while. To view that mountain, i trekked for 6 long days starting from Skardu town and reached Concordia camp site. During the first night, while every […]
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            ...
                            <li class="col-md-8">
                                <div class="pull-left">
                                    <span class="blog_header">Off to Nanga Parbat Basecamp

</span><br/>
                                    <span>Location : <a class="link_orange" href="#"><span class="txt_orange">Islamabad</span></a></span>
                                </div>
                                <div class="pull-right">
                                    <a href="#" role="button">16 Sep 2k14</a>
                                </div>
                                <div class="clearfix"> </div>
                                <p class="blog_text">
                                    I had been waiting so long to go to Fairy meadows and Nanga Parbat base camp. The recent incident at the base camp was sad and i had to give my plan a second thought. Fairy meadows is one of the prior places i wanted to go back in my childhood. I still remember that […
                                </p>
                            </li>
                        </ul>
                    </div><!-- /.blog_post 2 -->
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            ...
                            <li class="col-md-8">
                                <div class="pull-left">
                                    <span class="blog_header">I am in Swat</span><br/>
                                    <span>Location : <a class="link_orange" href="#"><span class="txt_orange">Islamabad</span></a></span>
                                </div>
                                <div class="pull-right">
                                    <a href="#" role="button">1 Dec 2k14</a>
                                </div>
                                <div class="clearfix"> </div>
                                <p class="blog_text">
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            ...
                            <li class="col-md-8">
                                <div class="pull-left">
                                    <span class="blog_header">Ten minutes on top of the world</span><br/>
                                    <span>Location : <a class="link_orange" href="#"><span class="txt_orange">Islamabad</span></a></span>
                                </div>
                                <div class="pull-right">
                                    <a  href="#" role="button">10 DEc 2k14</a>
                                </div>
                                <div class="clearfix"> </div>
                                <p class="blog_text">
                                   It was just before dawn as I pulled the ropes to climb to the top while taking deep breaths. The summit was a only a few feet away. I paused for a while, caught my breath and looked behind. The sky was a palette of orange and blue hues as spectacular mountains were silhouetted in […]
