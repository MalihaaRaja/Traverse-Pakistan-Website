        ...
        if(!($_SESSION['user']))
{
        ...
        $body = $_POST["body"];
          ...
          $preview_descrip=$_POST['preview_descrip'];
...
$sql = "INSERT INTO articles "."(title,body,photo,person_id,preview_descrip,post_date)"." VALUES('$title', '$body','$imgData','$person_id','$preview_descrip','$date')";
...
header('Location:addarticlebtn.php');
} 
else
 {
    echo $sql;
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="addarticle.php">Publish Article</a></li>
...
<div class="form-group">
      <label for="preview_descrip" class="col-sm-2 control-label">Preview Decription</label>
      <div class="col-sm-5">
         <input type="text" class="form-control" name="preview_descrip" id="preview_descrip" 
            placeholder="" required="">
      </div>
   </div>
