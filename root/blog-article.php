...
<body>
  ...
  //  echo  $article_id;
    ...
    $query= "SELECT id,title,body,post_date,person_id,photo FROM articles where id = $article_id";
    $result = mysql_query($query);
...
$about_you=$db_field1["about_you"];
    ...
    $query3 = "SELECT id,name,email,details,post_date FROM comments   WHERE article_id='$article_id'";
  ...
  $a=sizeof($result3);
        ...
        echo   " <div class='blog-item'>
                        ...
                        <div class='blog-content'>
                            <h3 style='padding-left:18px'> $title</h3>
                            <div class='entry-meta'>";
                             echo '<img  style="margin-left:15px;width="100px"" src="data:image/x-png;base64,'.base64_encode($image).'" width="680px" height="500px"/><br><br>';
...
echo "
                            ...
                            <div width='20px'>
                            <p class='lead' width='20px'style='padding-left:18px'> $body</p>
                            </div>
                            <hr>
    ...
    $query2 = "SELECT id,name,email,details,post_date FROM comments   WHERE article_id='$article_id'";
