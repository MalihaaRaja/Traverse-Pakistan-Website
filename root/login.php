...
<?php
    session_start();
    // if(isset($_SESSION["invalid"])=="false")
 //{
 ...
 //}
    ...
    { 
        ...
        $query="SELECT email, password FROM person WHERE email = '$email' AND password = '$password' ";
    ...
    <section id="registration" class="container">
        <form class="center" role="form" action="" method="post">
            <fieldset class="registration-form">
                ...
                <div class="form-group">
                    <button name="login" id="login" class="btn btn-success btn-md btn-block">Login</button>
                </div>
