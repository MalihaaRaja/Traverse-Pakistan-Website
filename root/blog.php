  ...
  if(isset( $_SESSION["user"]))
   ...
   //echo $email;
    ...
    $db_found = mysql_select_db($database, $db_handle);
        ...
        //echo $person_id;
        //echo $person;
        $query2= "SELECT * FROM articles  ORDER BY post_date DESC";
       ...
       while( $db_field2 = mysql_fetch_assoc($result2)){
        ...
        //echo "The size is",$size;
         ...
         $person_id=$db_field2['person_id'];

   $query = "SELECT id,userName,password,userDisplayName,contact_no,email,profile_pic FROM person   WHERE id='$person_id'";
